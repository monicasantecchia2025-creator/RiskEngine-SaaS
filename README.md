...
- Si al conectar cuenta recibes `Active subscription required before connecting account.`, verifica que el webhook `checkout.session.completed` llegó y que la suscripción quedó `ACTIVE`/`TRIALING`.
